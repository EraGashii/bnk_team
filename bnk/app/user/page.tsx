    ...
    <UserDashboardComponent>
      <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="bg-green-600 py-6 text-white text-center w-full">
          <h1 className="text-4xl font-bold white">Welcome to your Dashboard</h1>
          <p className="text-xl text-green-600">Manage your account and transactions here.</p>
        </div>
        ...
        <div className="max-w-full mx-auto mt-8 p-8 bg-gray-100 shadow-lg rounded-lg">
          ...
          <p className="text-lg text-green-600">Here you can see your recent activities, balance, and other important info.</p>
        </div>
      </div>
    </UserDashboardComponent>
  );
