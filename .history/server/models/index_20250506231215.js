...
fs
  ...
  if (db.Employee && db.Contract) {
    db.Employee.hasMany(db.Contract, { foreignKey: "Id" });
    db.Contract.belongsTo(db.Employee, { foreignKey: "Id" });
  }
  ...
  if (db.Planet && db.Ligjerata) {
    db.Planet.hasMany(db.Ligjerata, { foreignKey: "LecturerId" });
    db.Ligjerata.belongsTo(db.Planet, { foreignKey: "LecturerId" });
  }
