...
const LigjeruesiContractManager: React.FC = () => {
  ...
  const [ContractData, setContractData] = useState({ Title: "",Description:"",  LecturerId: "" });
  ...
  const handleAddContract = async () => {
    const fixedData = {
      ...ContractData,
       LecturerId: Number(ContractData. LecturerId), // 🛠 CONVERT to number
    };
  
    await addLigjerata(fixedData);
    setContractData({ Title: "", Description: "",  LecturerId: "" });
    loadContract();
  };
        ...
        {tab === "Contract" && (
          <div>
            ...
            <div className="flex gap-2 mb-4">
              ...
              <select name=" LecturerId" value={ContractData. LecturerId} onChange={handleContractInput} className="bg-[#222] text-white border border-gray-700 px-3 py-2 w-1/4">
