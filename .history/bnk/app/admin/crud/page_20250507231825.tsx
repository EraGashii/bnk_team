...
const TeamPlayerManager: React.FC = () => {
  ...
  const [PlayerData, setPlayerData] = useState({  Title:"",Number:0, BirthYear:0, TeamId: "" });
  ...
  const handleAddPlayer = async () => {
    ...
    setPlayerData({ Title:"", Description:"",TeamId: "" });
    loadPlayer();
  };
            ...
            <table className="min-w-full border border-gray-700">
              <thead className="bg-gray-800 text-white">
                <tr>
                  ...
                  <th className="p-2 text-left">TeamSurnamee</th>
                  <th className="p-2 text-center">Actions</th>
                </tr>
              </thead>
              <tbody className="bg-[#111]">
