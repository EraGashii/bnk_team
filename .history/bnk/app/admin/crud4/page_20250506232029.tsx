                ...
                {Planets.map((Planet,i) => (
                  <tr key={Planet.LecturerId} className="border-t border-gray-700">
                    ...
                    <td className="p-2 text-center space-x-3">
                      <button className="text-yellow-500 hover:text-yellow-600" onClick={() => { setEditPlanet(Planet); setName(Planet.Name);setDepartment(Planet.department);setEmail(Planet.email);}}>
                        <FiEdit size={18} />
                      </button>
