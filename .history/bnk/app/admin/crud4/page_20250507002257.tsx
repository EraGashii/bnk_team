...
const EmployeeContractManager: React.FC = () => {
  ...
  const [ContractData, setContractData] = useState({  Title: "",Description:"", EmployeeId: "" });
  ...
  const handleAddContract = async () => {
    ...
    setContractData({ Title:"" ,Description:"", EmployeeId:"" });
    loadContract();
  };
        ...
        {tab === "Contract" && (
          <div>
            ...
            <div className="flex gap-2 mb-4">
              <input type="text" name="Title" placeholder="Type" value={ContractData.Title} onChange={handleContractInput} className="bg-[#222] text-white border border-gray-700 px-3 py-2 w-1/4" />   
                ...
                {Employees.map((Employee,i) => (
                  <tr key={Employee.EmployeeId} className="border-t border-gray-700">
                    ...
                    <td className="p-2 text-center space-x-3">
                      <button className="text-yellow-500 hover:text-yellow-600" onClick={() => { setEditEmployee(Employee); setName(Employee.Name);setSurname(Employee.Surname);}}>
                        <FiEdit size={18} />
                      </button>
