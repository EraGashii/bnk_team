        ...
        {tab === "Contract" && (
          <div>
            ...
            <div className="flex gap-2 mb-4">
              ...
              <input type="text" name=" Description" placeholder=" Description" value={ContractData.Title} onChange={handleContractInput} className="bg-[#222] text-white border border-gray-700 px-3 py-2 w-1/4" />   
