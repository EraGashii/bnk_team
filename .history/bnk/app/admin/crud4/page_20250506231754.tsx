...
const LigjeruesiSateliteManager: React.FC = () => {
  const [tab, setTab] = useState<"Satelite" | "Ligjeruesis">("Satelite");
  ...
  return (
    <div className="flex min-h-screen bg-background text-white">
      ...
      <main className="flex-1 p-10">
        <h1 className="text-3xl font-bold mb-6">Ligjeruesi & Satelite Management</h1>
...
export default LigjeruesiSateliteManager;
