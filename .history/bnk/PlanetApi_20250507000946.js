...
// 👤 PLAYER
export const fetchContract = async () => (await api.get("/satelites")).data;
export const addContract = async (Contract) => api.post("/satelites", Contract);
export const deleteContract = async (id) => api.delete(`/satelites/${id}`);
