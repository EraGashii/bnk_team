...
export const addLigjeruesi = async (name,Department) => api.post("/Ligjeruesis", { LecturerName: lecturerName,Department:department });
export const updateLigjeruesi = async (id, name,Department) => api.put(`/Ligjeruesis/${id}`, { LecturerName: lecturerName });
