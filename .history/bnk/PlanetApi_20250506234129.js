...
// 👤 PLAYER
export const fetchSatelite = async () => (await api.get("/satelites")).data;
export const addSatelite = async (Satelite) => api.post("/satelites", Satelite);
export const deleteSatelite = async (id) => api.delete(`/satelites/${id}`);
