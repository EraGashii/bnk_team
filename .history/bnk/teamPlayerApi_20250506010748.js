...
// 👤 PLAYER
export const fetchLigjeratas = async () => (await api.get("/players")).data;
export const addLigjerata = async (player) => api.post("/players", player);
export const deleteLigjerata = async (id) => api.delete(`/players/${id}`);
