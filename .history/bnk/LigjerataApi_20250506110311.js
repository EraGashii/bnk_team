...
export const updateLigjeruesi = async (id, 
    LecturerName,department,email) => api.put(`/Ligjeruesis/${id}`, { LecturerName: LecturerName,department:department,email:email});
